...
# Definindo a posição e o ângulo inicial do robô
...
while robot.step(TIME_STEP) != -1:
    ...
    if contadorReset > reset + 1000:
        ...
        if (geracao >= 0 and geracao < 100):
            ...
            # Aumentando o valor do Kp em 0.1, outros valores devem ser testados, 0.01? 1? 10? 0.000001?
            kp += 0.1
            momento = [media, kp]
        elif (geracao >= 100 and geracao < 200):
            if validadorD:
                momento = []
                validadorD = False

            # Buscando o melhor indivíduo do Kp
            ...
            # Aumentando o valor do Kd em 0.1, outros valores devem ser testados, 0.01? 1? 10? 0.000001?
            kd += 0.1
            momento = [media, kd]
        elif (geracao >= 200 and geracao < 300):
            if validadorI:
                momento = []
                validadorI

            # Buscando o melhor indivíduo do Kd
            ...
            # Aumentando o valor do Ki em 0.00001, outros valores devem ser testados, 0.01? 1? 10? 0.000000001?
            ki += 0.00001
            momento = [media, ki]
            ...
            # Buscando o melhor individuo do Ki
            ...
            #Gerando gráfico de desempenho das gerações
            animateGeracoes()
            animateGeracoesKd()
            animateGeracoesKi()

            #Terminando todo processo, Pycharm e Webots
            Supervisor.simulationReset(robot)
            quit()

        # Lógica de gerações para rodar o código várias vezes
